  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative bg-white">
      ...
      <Image
        ...
        priority
      />
      {/* Login container above the background */}
      <div className="w-full max-w-5xl h-[80vh] flex flex-col md:flex-row shadow-2xl relative z-10">
        {/* Left: Blue side with logo and doctors illustration */}
        <div className="md:w-1/2 w-full flex flex-col justify-between items-center bg-[#0a3557]  px-6 rounded-tl-3xl rounded-bl-3xl h-full">
        ...
        {/* Right: Login Form */}
        <div className="md:w-1/2  flex flex-col justify-center bg-[#92DCE53D] backdrop-blur-md p-8 md:p-12 rounded-tr-3xl rounded-br-3xl border-l border-white/40 ">
          <div className="flex rounded-2xl border border-[#5ec7c0] bg-transparent shadow-md overflow-hidden mb-8">
    <button
    ...
    <button
      className="px-8 py-3 font-semibold text-[#073c57] bg-transparent"
    >
      Sign-up
    </button>
    </div>
    <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between text-xs text-gray-600">
              <label className="flex items-center gap-2">
                <input type="checkbox" className="accent-[#0a3557]" /> Remember me
              </label>
              <button type="button" className="hover:underline text-[#0a3557]">Forgot Password?</button>
            </div>
            <button
              type="submit"
